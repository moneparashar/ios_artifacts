...
class NoteDataHelper: DataHelperProtocol {
    typealias T = Note
    ...
    static func update(item: T) throws -> Int{
        ...
        static func find(uid: String) throws -> T? {
            ...
            for item in  items {
                return NoteDataHelper.convertRow(item: item)
            }
        ...
        static func findAll() throws -> [T]? {
            ...
            for item in items {
                retArray.append(NoteDataHelper.convertRow(item: item))
            }
    ...
    static func convertRow(item:Row) -> Note{
