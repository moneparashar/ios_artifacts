...
//  vivally
//
//  Created by Nadia Karina Camacho Cabrera on 7/21/21.
//
...
class PasswordToggleVisibilityView: UIView {
   // fileprivate let eyeOpenedImage = UIImage(systemName: "eye")
    ...
    override init(frame: CGRect) {
        //self.eyeOpenedImage = UIImage(named: "sleep", in: Bundle(for: PasswordToggleVisibilityView.self), compatibleWith: nil)!.withRenderingMode(.alwaysTemplate)
        //self.eyeClosedImage = UIImage(named: "eye_close", in: Bundle(for: PasswordToggleVisibilityView.self), compatibleWith: nil)!.withRenderingMode(.alwaysTemplate)
        ...
        self.checkmarkImage = UIImage(named: "water", in: Bundle(for: PasswordToggleVisibilityView.self), compatibleWith: nil)!.withRenderingMode(.alwaysTemplate)
